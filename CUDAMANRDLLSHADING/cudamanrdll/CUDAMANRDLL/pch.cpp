...
void FigureFOV(cv::Mat matYImage, int& nLeftA0, int& nRightA0, int& nLeftA1, int& nRightA1) {
	...
	ThreshDiffImage(matMeanDiffHImage, matMeanDiffHImage1, matDiffFilterHImage, matDiffFilterHImage1, 9, 240, 1.5, 6.0);
